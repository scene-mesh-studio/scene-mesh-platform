  ...
  return (
    ...
    >
      ...
      <Stack sx={{ p: '12px 16px' }} spacing={1.5}>
        ...
        >
          <Icon icon="mdi:brain" color='text.secondary' width={16} height={16} style={{ marginRight: '8px' }} />
          ...
          <Stack spacing={1}>
            {data.promptVariables && data.promptVariables.length > 0 ? (
              data.promptVariables.map((item) => (
                ...
                >
                  <Tooltip title="变量名">
                    <Icon icon="mdi:variable-box" color='text.secondary' width={16} height={16} style={{ marginRight: '8px' }} />
                  </Tooltip>
                  <Typography variant="body2" sx={{ fontWeight: 'medium' }}>
                    {item.variable}
                  </Typography>
